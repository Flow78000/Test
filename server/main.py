...
from routers import sierra, regime, market, proxy_uw, menthorq, messages, pricing, news, spread_gap, strange_days, news_trading, alpha_hunter
...
app.include_router(alpha_hunter.router, prefix="/api/alpha-hunter", tags=["Alpha Hunter"])
