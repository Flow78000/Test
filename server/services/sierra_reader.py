...
SIERRA_ASSETS = {
    ...
    "Bund": {"name": "Euro Bund (FGBL)", "class": "EUREX", "timeframe": "5min"},
    "GER30": {"name": "DAX 30", "class": "EUREX", "timeframe": "5min"},
    "EUSTX50": {"name": "Euro Stoxx 50", "class": "EUREX", "timeframe": "5min"},
    "VOLX": {"name": "VIX Futures EUREX", "class": "Volatilite", "timeframe": "5min"},
